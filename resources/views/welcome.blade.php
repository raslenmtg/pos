    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-7" data-aos="fade-right">
                ...
                <p class="hero-lead">
                    Synchronisez vos stocks, vos operations et votre facturation. Gagnez du temps et développez votre activité avec Simplex Gestion.
                </p>
                ...
                <div class="mt-4 text-muted small">
                    <i class='bx bx-check-circle text-success'></i> mise en place assistée
                    <span class="mx-2">•</span>
                    <i class='bx bx-check-circle text-success'></i> Démonstration en direct
                    <span class="mx-2">•</span>
                    <i class='bx bx-check-circle text-success'></i> service client 7j/7
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="bg-white text-dark rounded-4 p-5 shadow-lg">
                        ...
                        <div class="d-grid gap-3">
                            <a href="https://wa.me/21693796501?text=Bonjour%20Simplex,%20je%20souhaite%20une%20démonstration%20pour%20mon%20commerce."
                               onclick="fbq('track', 'Contact', {content_name: 'WhatsApp Inquiry', content_category: 'SaaS'});"
                               target="_blank" class="btn btn-primary btn-lg fw-bold">
