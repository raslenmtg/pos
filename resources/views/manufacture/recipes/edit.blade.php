@extends('layouts.app')
@section('title', __('manufacture.edit_recipe'))

@section('content')
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('manufacture.edit_recipe')</h1>
</section>

<section class="content">
    {!! Form::open(['url' => route('manufacture.recipes.update', $recipe->id), 'method' => 'put', 'id' => 'mfg_recipe_form']) !!}
