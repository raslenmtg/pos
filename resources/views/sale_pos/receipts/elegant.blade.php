            ...
            <div class="party-box to-box" style='border-bottom:none'>
                ...
                <div class="word-wrap">
                    @if(!empty($receipt_details->client_id_label))
                        <p>{{ $receipt_details->client_id_label }} <span >{{ $receipt_details->client_id_label }}:</span> {{ $receipt_details->client_id }}</p>
                    @endif
                    @if(!empty($receipt_details->sales_person_label))
                        <p><span >{{ $receipt_details->sales_person_label }}:</span> {{ $receipt_details->sales_person }}</p>
                    @endif
                    @if(!empty($receipt_details->commission_agent_label))
                        <p><span >{{ $receipt_details->commission_agent_label }}:</span> {{ $receipt_details->commission_agent }}</p>
                    @endif
        ...
        <section class="invoice-body">
            <table class="items-table">
                ...
                <tbody>
                    ...
                    @for ($i = $lines; $i < 7; $i++)
                        <tr class="empty-row @if($i == 6) last-empty-row @endif">
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            @if($receipt_details->show_cat_code == 1) <td>&nbsp;</td> @endif
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            @if(!empty($receipt_details->item_discount_label)) <td>&nbsp;</td> @endif
                            <td>&nbsp;</td>
                        </tr>
                    @endfor
                </tbody>
