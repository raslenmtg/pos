...
<head>
    ...
    <title>Blog - Simplex Gestion</title>
...
<main>
    <section class="blog-hero">
        <div class="container">
            <span class="blog-badge"><i class='bx bx-news'></i> Blog</span>
            <h1>Articles & actualités</h1>
            <p>Retrouvez ici les nouveautés produit, conseils pratiques et mises à jour autour de Simplex Gestion.</p>
        </div>
    </section>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <article class="blog-empty-card">
                        ...
                        <p class="blog-empty-text">Nous n’avons pas encore publié d’articles. Revenez bientôt pour découvrir les prochains contenus du blog Simplex Gestion.</p>
                    </article>
                </div>
            </div>
        </div>
