...
return [
    ...
    */
    ...
    'scan_invoice_ocr' => 'Scan Invoice (OCR)',
    'upload_supplier_invoice' => 'Upload Supplier Invoice',
    'ocr_file_help' => 'Supported formats: JPG, PNG, WEBP, PDF (max 10 MB)',
    'scan_and_extract' => 'Scan & Extract Products',
    'ocr_processing' => 'Analyzing invoice with AI, please wait...',
    'ocr_review_instructions' => 'Review the extracted products below. Correct any mismatches, then click Confirm.',
    'ocr_text_from_invoice' => 'Invoice Text (OCR)',
    'ocr_confidence' => 'Confidence',
    'ocr_confirm_add_to_purchase' => 'Confirm & Add to Purchase',
    'ocr_no_file_selected' => 'Please select an invoice file first.',
    'ocr_no_items_found' => 'No line items could be extracted from the invoice.',
    'ocr_items_added' => 'Products added to purchase from invoice scan.',
];
