...
Route::middleware([ 'auth', 'SetSessionData', 'language', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    // Invoice OCR scan routes
    Route::post('/invoice-scans/upload', [InvoiceScanController::class, 'upload'])->name('invoice-scans.upload');
    Route::post('/invoice-scans/confirm', [InvoiceScanController::class, 'confirm'])->name('invoice-scans.confirm');
    ...
    Route::get('/purchases/{id}/exportTEJ', [PurchaseController::class, 'exportTEJ']);
    ...
    Route::get('/payments/print-single-payment/{payment_id}', [TransactionPaymentController::class, 'printSinglePayment']);
    Route::get('/payments/print-lettre-de-change/{payment_id}', [TransactionPaymentController::class, 'printLettreDeChange']);
...
Route::middleware([ 'auth', 'SetSessionData', 'language'])->group(function () {
