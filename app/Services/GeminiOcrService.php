...
- Price must be TTC (taxes included). If only HT (hors taxe) price is available, calculate TTC using: TTC = (HT - item discount) * (1 + TVA/100). For example, if HT = 10.000 and TVA = 19%, then TTC = 10.000 * 1.19 = 11.900. Use the TVA rate extracted from that line item, or the general invoice TVA rate if no per-line rate is found.
PROMPT;
