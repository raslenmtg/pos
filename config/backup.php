...
return [
    ...
    'monitor_backups' => [
        [
            ...
            // Spatie expects an array of disk names here.
            // Allow comma-separated disks in BACKUP_DISK (e.g. "local,gcs").
            'disks' => array_filter(array_map('trim', explode(',', env('BACKUP_DISK', 'local')))),
            'health_checks' => [
